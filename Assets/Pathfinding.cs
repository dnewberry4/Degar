...
public class Pathfinding : MonoBehaviour
{
    ...
    public Node currentStart;
    public Node currentEnd;
    ...
    {
        ResetFinalPath();
        currentEnd = a_EndNode;
        currentStart = a_StartingNode;
        ...
        {
            print(pathNode.iGridX + " , " + pathNode.iGridY);
            Instantiate(debugMarker, pathNode.vPosition, new Quaternion(0,0,0,0));
        }
    ...
    void ResetFinalPath()
    {
        GridReference.FinalPath = new List<Node>();
        if (currentStart != null) { currentStart.bIsStart = false; }
        if (currentEnd != null) { currentEnd.bIsEnd = false; }   
    }

...
public class Node
{
    ...
    public bool bIsStart;//Tells the program if this node is being obstructed.
    public bool bIsEnd;//Tells the program if this node is being obstructed.
    public Vector3 vPosition;//The world position of the node.
    public Vector3 vCenter;//The world position of the node.
    ...
    public Node(bool a_bIsWall, Vector3 a_vPos, Vector3 a_vCent, int a_igridX, int a_igridY)//Constructor
    {
